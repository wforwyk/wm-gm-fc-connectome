...
INPUT   : dwi_aal      — dwi_wsst_all_ROIs_AAL_u_rc1sub-{subj}_ses-01_T1w_YOUR_DARTEL_TEMPLATE.nii
          fmri_aal     — fmri_wsst_all_ROIs_AAL_u_rc1sub-{subj}_ses-01_T1w_YOUR_DARTEL_TEMPLATE.nii
          fc           — {subj}_R.npz
          dist         — {subj}_W_a.npz

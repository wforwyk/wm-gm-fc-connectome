...
TPM_PATH  = '/path/to/your/spm12/tpm/TPM.nii';
...
for s = 1:length(SUBJECTS)
    ...
    try
        ...
        % ------------------------------------------------------------------
        % Job 3: Apply Bias Field (call_matlab)
        % inputs{1} : bias field image (from Job 2)
        % inputs{2} : resliced func images (from Job 1)
        % ------------------------------------------------------------------
        ...
        matlabbatch{3}.cfg_basicio.run_ops.call_matlab.inputs{2}.images(1) = cfg_dep('Realign: Estimate & Reslice: Resliced Images (Sess 1)', ...
            substruct('.','val','{}',{1},'.','val','{}',{1},'.','val','{}',{1},'.','val','{}',{1}), ...

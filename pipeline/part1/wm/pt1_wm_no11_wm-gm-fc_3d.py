...
PIPELINE CONTEXT:
  ...
  template no03 → dwi_wsst_all_ROIs_AAL_{subj}.nii            (DWI AAL atlas)
  template no03 → fmri_wsst_all_ROIs_AAL_{subj}.nii           (fMRI AAL atlas)
...
INPUT   : dwi_aal      — dwi_wsst_all_ROIs_AAL_u_rc1sub-{subj}_{SOURCE_SESSION}_T1w_{DARTEL_TEMPLATE_ID}.nii
          fmri_aal     — fmri_wsst_all_ROIs_AAL_u_rc1sub-{subj}_{SOURCE_SESSION}_T1w_{DARTEL_TEMPLATE_ID}.nii
          fc           — {subj}_R.npz
          dist         — {subj}_W_a.npz
...
LUT = "/path/to/your/project/derivatives/template/AAL3/AAL3v1.nii.txt"
...
def run_subject(subj, lut):
    dwi_aal   = f"{BASE_DIR}/{subj}/gm/derived/dwi_wsst_all_ROIs_AAL_u_rc1sub-{subj}_{SOURCE_SESSION}_T1w_{DARTEL_TEMPLATE_ID}.nii"
    fmri_aal  = f"{BASE_DIR}/{subj}/gm/derived/fmri_wsst_all_ROIs_AAL_u_rc1sub-{subj}_{SOURCE_SESSION}_T1w_{DARTEL_TEMPLATE_ID}.nii"

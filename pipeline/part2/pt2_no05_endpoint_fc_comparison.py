...
LABEL_DIR = '/path/to/your/project/derivatives/pt2_group_results/no4_endpoint_voxels'
OUTPUT_DIR = '/path/to/your/project/derivatives/pt2_group_results/no5_endpoint_fc'
...
def main():
    ...
    for subj in subjects:
        ...
        aal=nib.load(os.path.join(base,'gm','derived',f'fmri_wsst_all_ROIs_AAL_u_rc1sub-{subj}_{SOURCE_SESSION}_T1w_{DARTEL_TEMPLATE_ID}.nii')).get_fdata().astype(int)[gm]

...
%               fmri_wsst_all_ROIs_AAL_u_rc1sub-{subject}_ses-01_T1w_YOUR_DARTEL_TEMPLATE.nii
%               dwi_wsst_all_ROIs_AAL_u_rc1sub-{subject}_ses-01_T1w_YOUR_DARTEL_TEMPLATE.nii
%
...
for i = 1:numel(SUBJECTS)
    ...
    aal_t1   = fullfile(der_dir,  ['wsst_all_ROIs_AAL_' flow_name]);
